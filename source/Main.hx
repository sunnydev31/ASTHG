...
class Main extends Sprite {
	...
	public function new() {	
		...
		function onCrash(e:openfl.events.UncaughtErrorEvent) {
			final folderPath:String = "./crash/";
			var date:String = DateTools.format(Date.now(), Locale.getString("format_date", null, ["-", "-"])
			+ "_" + Locale.getString("format_hour", null, ["-", "-"]));
